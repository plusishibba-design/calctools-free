    ...
    <div className="editorial-page">
      <div className="editorial-page-inner">
        ...
        <article className="prose" data-reveal style={{ marginTop: '2rem' }}>
          ...
          <h2>Accuracy</h2>
          <p>
            We use standard finance formulas (PMT, amortization, etc.) and do our best to keep
            calculators accurate. However, we make no guarantee that every result is correct in
            every edge case. You are responsible for verifying any number you rely on for an
          ...
          <p>
            ...
            loss, damage, or claim arising from your use of the calculators or any decision made
          ...
          <p>
            ...
            You may freely use the calculators for your own personal or business purposes, but you
            may not republish the site\'s content as your own.
          </p>
